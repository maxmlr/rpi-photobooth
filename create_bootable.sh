...
# ARG_OPTIONAL_SINGLE([wifi],[w],[path to dietpi wifi file],[])
...
{
	local first_option all_short_options='gcwkph'
	first_option="${1:0:1}"
...
{
	printf '%s\n' "Show help"
	printf 'Usage: %s [-g|--git <arg>] [-c|--config <arg>] [-w|--wifi <arg>] [-k|--key <arg>] [-p|--photobooth <arg>] [-h|--help] <image>\n' "$0"
	...
	printf '\t%s\n' "-w, --wifi: path to dietpi wifi file (no default)"
